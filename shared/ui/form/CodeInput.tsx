...
import { normalizeDigits } from "@/shared/lib/utils";
...
export default function CodeInput({
  ...
  const digits = useMemo(() => {
    const v = normalizeDigits(value, maxLength);
  ...
  return (
    <div className="text-left">
      ...
      <div onClick={focus} className="relative w-full cursor-text">
        ...
        <input
          ref={inputRef}
          value={normalizeDigits(value, maxLength)}
          onChange={(e) => onChange(normalizeDigits(e.target.value, maxLength))}
