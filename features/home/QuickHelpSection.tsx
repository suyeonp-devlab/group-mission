  ...
  return (
    <section className="mt-8">
      ...
      <div className="divide-y divide-zinc-100 overflow-hidden rounded-2xl bg-white ring-1 ring-zinc-200">
        {/* Notice */}
        <Link href="/app/helpdesk?tab=notice" className="flex items-center justify-between px-4 py-4 transition active:scale-[0.98]">
        ...
        {/* FAQ */}
        <Link href="/app/helpdesk?tab=faq" className="flex items-center justify-between px-4 py-4 transition active:scale-[0.98]">
          <div className="flex items-center gap-3">
            <div className="flex h-9 w-9 items-center justify-center rounded-full bg-emerald-50 ring-1 ring-emerald-100">
