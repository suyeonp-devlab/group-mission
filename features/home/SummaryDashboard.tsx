...
export default function SummaryDashboard({summary}: SummaryDashboardProps) {
  ...
  const totalStatus = getSummaryStatus(total.count, total.completed);

  const summaryUI = MISSION_STATUS_UI[totalStatus];

  return (
    <section className="rounded-md border border-emerald-400 px-4 py-4 shadow-[0_8px_24px_rgba(15,23,42,0.06)]">
