...
import { Notification, NOTIFICATION_TYPE_LABEL, NotificationType } from "@/features/notifications/notification.type";
...
const BADGE_CLASS: Record<NotificationType, string> = {
