...
import CodeInput from "@/shared/ui/form/CodeInput";
import type { FindPasswordFormType } from "@/features/auth/components/FindPasswordForm";

interface FindPasswordFormStepOneProps {
  onNext: () => void;
}

export default function FindPasswordFormStepOne({ onNext } : FindPasswordFormStepOneProps) {
