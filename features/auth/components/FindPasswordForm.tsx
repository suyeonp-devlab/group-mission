...
import StepIndicator, {StepItem} from "@/shared/ui/indicator/StepIndicator";
import FindPasswordFormStepOne from "@/features/auth/components/FindPasswordFormStepOne";
import FindPasswordFormStepTwo from "@/features/auth/components/FindPasswordFormStepTwo";
  ...
  return (
    <FormProvider {...methods}>
      <div className="text-left">
        ...
        {step === 1 && <FindPasswordFormStepOne onNext={next} />}
        {step === 2 && <FindPasswordFormStepTwo onSubmit={submit} />}
      </div>
    </FormProvider>
  );
}