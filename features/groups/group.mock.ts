...
export const MOCK_GROUPS: Group[] = [
  ...
  { id: "G202603040007", title: "스트레칭 10분 스트레칭 10분 스트레칭 10분 스트레칭 10분", description: "몸 펴는 것부터 같이 해요. 스트레칭 10분 스트레칭 10분 스트레칭 10분 스트레칭 10분 스트레칭 10분", categoryId: "01", frequency: "DAILY", memberCount: 7, maxMembers: 10, completeMember: 7, badges: ["SUCCESS", "TRENDING"], recommendedScore: 100, achieveRate: 100, createdAt: "2026-02-02T14:32:10" },
